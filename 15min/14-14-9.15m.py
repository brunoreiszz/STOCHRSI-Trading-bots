...
closes = [1531.01, 1522.54, 1526.44, 1520.48, 1531.72, 1521.06, 1521.17, 1523.67, 1529.87, 1528.68, 1526.67, 1518.86, 1508.31, 1507.22, 1498.46]
in_position = False
num_trades = 0
price_buy = 0
price_sell = 0
...
def on_message(ws, message):
    ...
    if isCandleClosed:
        print("---\nLong 14-14-9 15min Candle closed at {}\n---".format(close))
        ...
        if len(closes) > RSI_PERIOD:
            ...
            last_rsi = rsi[-1]
            print("----\nRSI is {}".format(last_rsi))
            
            fastk, fastd = ti.stoch(rsinp, rsinp, rsinp, 14, 9, 3)
            #print("fast k values:")
            #print(fastk)
            #print("fast d values:")
            #print(fastd)
